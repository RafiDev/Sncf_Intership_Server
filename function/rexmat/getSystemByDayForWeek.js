...
function weekH2(systeme, date, info) {
    ...
    for (let j = 0; j != info.filter(isUnique).length; j++) {
        for (let i = 0; i != systeme.length && i != date.length; i++) {
            if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'BS' && date[i] === info.filter(isUnique)[j]) {
                weekBS[info.filter(isUnique)[j]] = ++nbBS;
                if (isNaN(weekBS[info.filter(isUnique)[j-1]])) {
                    bs = weekBS[info.filter(isUnique)[j]];
                } else {
                ...
                objBS[info.filter(isUnique)[j]] = bs;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'CLIMATISATION' && date[i] === info.filter(isUnique)[j]) {
                weekClim[info.filter(isUnique)[j]] = ++nbClim;
                if (isNaN(weekClim[info.filter(isUnique)[j-1]])) {
                    clim = weekClim[info.filter(isUnique)[j]];
                } else {
                ...
                objClim[info.filter(isUnique)[j]] = clim;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'COMPRESSEUR' && date[i] === info.filter(isUnique)[j]) {
                weekComp[info.filter(isUnique)[j]] = ++nbComp;
                if (isNaN(weekComp[info.filter(isUnique)[j-1]])) {
                    comp = weekComp[info.filter(isUnique)[j]];
                } else {
                ...
                objComp[info.filter(isUnique)[j]] = comp;
            } else if (systeme[i].split('_')[1] === 'H2' && (systeme[i].split('_')[2] === 'Detection' && systeme[i].split('_')[3] ==='incendie') && date[i] === info.filter(isUnique)[j]) {
                weekDetec[info.filter(isUnique)[j]] = ++nbDetec;
                if (isNaN(weekDetec[info.filter(isUnique)[j-1]])) {
                    detec = weekDetec[info.filter(isUnique)[j]];
                } else {
                ...
                objDetec[info.filter(isUnique)[j]] = detec;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'CCTV' && date[i] === info.filter(isUnique)[j]) {
                weekCctv[info.filter(isUnique)[j]] = ++nbCctv;
                if (isNaN(weekCctv[info.filter(isUnique)[j-1]])) {
                    cctv = weekCctv[info.filter(isUnique)[j]];
                } else {
                ...
                objCctv[info.filter(isUnique)[j]] = cctv;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'TCMS' && date[i] === info.filter(isUnique)[j]) {
                weekTcms[info.filter(isUnique)[j]] = ++nbTcms;
                if (isNaN(weekTcms[info.filter(isUnique)[j-1]])) {
                    tcms = weekTcms[info.filter(isUnique)[j]];
                } else {
                ...
                objTcms[info.filter(isUnique)[j]] = tcms;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'TRACTION' && date[i] === info.filter(isUnique)[j]) {
                weekTrac[info.filter(isUnique)[j]] = ++nbTrac;
                if (isNaN(weekTrac[info.filter(isUnique)[j-1]])) {
                    trac = weekTrac[info.filter(isUnique)[j]];
                } else {
                ...
                objTrac[info.filter(isUnique)[j]] = trac;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'ATESS' && date[i] === info.filter(isUnique)[j]) {
                weekAtess[info.filter(isUnique)[j]] == ++nbAtess;
                if (isNaN(weekAtess[info.filter(isUnique)[j-1]])) {
                    atess = weekAtess[info.filter(isUnique)[j]];
                } else {
                ...
                objAtess[info.filter(isUnique)[j]] = atess;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'TDB' && date[i] === info.filter(isUnique)[j]) {
                weekTdb[info.filter(isUnique)[j]] = ++nbTdb;
                if (isNaN(weekTdb[info.filter(isUnique)[j-1]])) {
                    tdb = weekTdb[info.filter(isUnique)[j]];
                } else {
                ...
                objTdb[info.filter(isUnique)[j]] = tdb;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'EMCO' && date[i] === info.filter(isUnique)[j]) {
                weekEmco[info.filter(isUnique)[j]] = ++nbEmco;
                if (isNaN(weekEmco[info.filter(isUnique)[j-1]])) {
                    emco = weekEmco[info.filter(isUnique)[j]];
                } else {
                ...
                objEmco[info.filter(isUnique)[j]] = emco;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'EQS' && date[i] === info.filter(isUnique)[j]) {
                weekEqs[info.filter(isUnique)[j]] = ++nbEqs;
                if (isNaN(weekEqs[info.filter(isUnique)[j-1]])) {
                    eqs = weekEqs[info.filter(isUnique)[j]];
                } else {
                ...
                objEqs[info.filter(isUnique)[j]] = eqs;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'PORTE' && date[i] === info.filter(isUnique)[j]) {
                weekPorte[info.filter(isUnique)[j]] = ++nbPorte;
                if (isNaN(weekPorte[info.filter(isUnique)[j-1]])) {
                    porte = weekPorte[info.filter(isUnique)[j]];
                } else {
                ...
                objPorte[info.filter(isUnique)[j]] = porte;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'FREIN' && date[i] === info.filter(isUnique)[j]) {
                weekFrein[info.filter(isUnique)[j]] = ++nbFrein;
                if (isNaN(weekFrein[info.filter(isUnique)[j-1]])) {
                    frein = weekFrein[info.filter(isUnique)[j]];
                } else {
                ...
                objFrein[info.filter(isUnique)[j]] = frein;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'ComptagePassagers' && date[i] === info.filter(isUnique)[j]) {
                weekCompPass[info.filter(isUnique)[j]] = ++nbCompPass;
                if (isNaN(weekCompPass[info.filter(isUnique)[j-1]])) {
                    compPass = weekCompPass[info.filter(isUnique)[j]];
                } else {
                ...
                objCompPass[info.filter(isUnique)[j]] = compPass;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'AFFICHEUR' && date[i] === info.filter(isUnique)[j]) {
                weekAff[info.filter(isUnique)[j]] = ++nbAff;
                if (isNaN(weekAff[info.filter(isUnique)[j-1]])) {
                    aff = weekAff[info.filter(isUnique)[j]];
                } else {
                ...
                objAff[info.filter(isUnique)[j]] = aff;
            } else if (systeme[i].split('_')[1] === 'H2' && (systeme[i].split('_')[2] === 'LECTEUR' && systeme[i].split('_')[3] === 'BADGE') && date[i] === info.filter(isUnique)[j]) {
                weekLect[info.filter(isUnique)[j]] = ++nbLect;
                if (isNaN(weekLect[info.filter(isUnique)[j-1]])) {
                    lect = weekLect[info.filter(isUnique)[j]];
                } else {
                ...
                objLect[info.filter(isUnique)[j]] = lect;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'ECLAIRAGE' && date[i] === info.filter(isUnique)[j]) {
                weekEcl[info.filter(isUnique)[j]] = ++nbEcl;
                if (isNaN(weekEcl[info.filter(isUnique)[j-1]])) {
                    ecl = weekEcl[info.filter(isUnique)[j]];
                } else {
                ...
                objEcl[info.filter(isUnique)[j]] = ecl;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'PUPITRE' && date[i] === info.filter(isUnique)[j]) {
                weekPup[info.filter(isUnique)[j]] = ++nbPup;
                if (isNaN(weekPup[info.filter(isUnique)[j-1]])) {
                    pup = weekPup[info.filter(isUnique)[j]];
                } else {
                ...
                objPup[info.filter(isUnique)[j]] = pup;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'SONO' && date[i] === info.filter(isUnique)[j]) {
                weekSono[info.filter(isUnique)[j]] = ++nbSono;
                if (isNaN(weekSono[info.filter(isUnique)[j-1]])) {
                    sono = weekSono[info.filter(isUnique)[j]];
                } else {
                ...
                objSono[info.filter(isUnique)[j]] = sono;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'COUPLEUR' && date[i] === info.filter(isUnique)[j]) {
                weekCoup[info.filter(isUnique)[j]] = ++nbCoup;
                if (isNaN(weekCoup[info.filter(isUnique)[j-1]])) {
                    coup = weekCoup[info.filter(isUnique)[j]];
                } else {
                ...
                objCoup[info.filter(isUnique)[j]] = coup;
            } else if (systeme[i].split('_')[1] === 'H2' && systeme[i].split('_')[2] === 'STMAutonome' && date[i] === info.filter(isUnique)[j]) {
                weekStm[info.filter(isUnique)[j]] = ++nbStm;
                if (isNaN(weekStm[info.filter(isUnique)[j-1]])) {
                    stm = weekStm[info.filter(isUnique)[j]];
                } else {
...
function weekH3(systeme, date, info) {
    ...
    for (let j = 0; j != info.filter(isUnique).length; j++) {
        for (let i = 0; i != systeme.length && i != date.length; i++) {
            if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'BS' && date[i] === info.filter(isUnique)[j]) {
                weekBS[info.filter(isUnique)[j]] = ++nbBS;
                if (isNaN(weekBS[info.filter(isUnique)[j-1]])) {
                    bs = weekBS[info.filter(isUnique)[j]];
                } else {
                ...
                objBS[info.filter(isUnique)[j]] = bs;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'CLIMATISATION' && date[i] === info.filter(isUnique)[j]) {
                weekClim[info.filter(isUnique)[j]] = ++nbClim;
                if (isNaN(weekClim[info.filter(isUnique)[j-1]])) {
                    clim = weekClim[info.filter(isUnique)[j]];
                } else {
                ...
                objClim[info.filter(isUnique)[j]] = clim;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'COMPRESSEUR' && date[i] === info.filter(isUnique)[j]) {
                weekComp[info.filter(isUnique)[j]] = ++nbComp;
                if (isNaN(weekComp[info.filter(isUnique)[j-1]])) {
                    comp = weekComp[info.filter(isUnique)[j]];
                } else {
                ...
                objComp[info.filter(isUnique)[j]] = comp;
            } else if (systeme[i].split('_')[1] === 'H3' && (systeme[i].split('_')[2] === 'Detection' && systeme[i].split('_')[3] ==='incendie') && date[i] === info.filter(isUnique)[j]) {
                weekDetec[info.filter(isUnique)[j]] = ++nbDetec;
                if (isNaN(weekDetec[info.filter(isUnique)[j-1]])) {
                    detec = weekDetec[info.filter(isUnique)[j]];
                } else {
                ...
                objDetec[info.filter(isUnique)[j]] = detec;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'CCTV' && date[i] === info.filter(isUnique)[j]) {
                weekCctv[info.filter(isUnique)[j]] = ++nbCctv;
                if (isNaN(weekCctv[info.filter(isUnique)[j-1]])) {
                    cctv = weekCctv[info.filter(isUnique)[j]];
                } else {
                ...
                objCctv[info.filter(isUnique)[j]] = cctv;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'TCMS' && date[i] === info.filter(isUnique)[j]) {
                weekTcms[info.filter(isUnique)[j]] = ++nbTcms;
                if (isNaN(weekTcms[info.filter(isUnique)[j-1]])) {
                    tcms = weekTcms[info.filter(isUnique)[j]];
                } else {
                ...
                objTcms[info.filter(isUnique)[j]] = tcms;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'TRACTION' && date[i] === info.filter(isUnique)[j]) {
                weekTrac[info.filter(isUnique)[j]] = ++nbTrac;
                if (isNaN(weekTrac[info.filter(isUnique)[j-1]])) {
                    trac = weekTrac[info.filter(isUnique)[j]];
                } else {
                ...
                objTrac[info.filter(isUnique)[j]] = trac;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'ATESS' && date[i] === info.filter(isUnique)[j]) {
                weekAtess[info.filter(isUnique)[j]] == ++nbAtess;
                if (isNaN(weekAtess[info.filter(isUnique)[j-1]])) {
                    atess = weekAtess[info.filter(isUnique)[j]];
                } else {
                ...
                objAtess[info.filter(isUnique)[j]] = atess;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'TDB' && date[i] === info.filter(isUnique)[j]) {
                weekTdb[info.filter(isUnique)[j]] = ++nbTdb;
                if (isNaN(weekTdb[info.filter(isUnique)[j-1]])) {
                    tdb = weekTdb[info.filter(isUnique)[j]];
                } else {
                ...
                objTdb[info.filter(isUnique)[j]] = tdb;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'EMCO' && date[i] === info.filter(isUnique)[j]) {
                weekEmco[info.filter(isUnique)[j]] = ++nbEmco;
                if (isNaN(weekEmco[info.filter(isUnique)[j-1]])) {
                    emco = weekEmco[info.filter(isUnique)[j]];
                } else {
                ...
                objEmco[info.filter(isUnique)[j]] = emco;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'EQS' && date[i] === info.filter(isUnique)[j]) {
                weekEqs[info.filter(isUnique)[j]] = ++nbEqs;
                if (isNaN(weekEqs[info.filter(isUnique)[j-1]])) {
                    eqs = weekEqs[info.filter(isUnique)[j]];
                } else {
                ...
                objEqs[info.filter(isUnique)[j]] = eqs;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'PORTE' && date[i] === info.filter(isUnique)[j]) {
                weekPorte[info.filter(isUnique)[j]] = ++nbPorte;
                if (isNaN(weekPorte[info.filter(isUnique)[j-1]])) {
                    porte = weekPorte[info.filter(isUnique)[j]];
                } else {
                ...
                objPorte[info.filter(isUnique)[j]] = porte;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'FREIN' && date[i] === info.filter(isUnique)[j]) {
                weekFrein[info.filter(isUnique)[j]] = ++nbFrein;
                if (isNaN(weekFrein[info.filter(isUnique)[j-1]])) {
                    frein = weekFrein[info.filter(isUnique)[j]];
                } else {
                ...
                objFrein[info.filter(isUnique)[j]] = frein;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'ComptagePassagers' && date[i] === info.filter(isUnique)[j]) {
                weekCompPass[info.filter(isUnique)[j]] = ++nbCompPass;
                if (isNaN(weekCompPass[info.filter(isUnique)[j-1]])) {
                    compPass = weekCompPass[info.filter(isUnique)[j]];
                } else {
                ...
                objCompPass[info.filter(isUnique)[j]] = compPass;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'AFFICHEUR' && date[i] === info.filter(isUnique)[j]) {
                weekAff[info.filter(isUnique)[j]] = ++nbAff;
                if (isNaN(weekAff[info.filter(isUnique)[j-1]])) {
                    aff = weekAff[info.filter(isUnique)[j]];
                } else {
                ...
                objAff[info.filter(isUnique)[j]] = aff;
            } else if (systeme[i].split('_')[1] === 'H3' && (systeme[i].split('_')[2] === 'LECTEUR' && systeme[i].split('_')[3] === 'BADGE') && date[i] === info.filter(isUnique)[j]) {
                weekLect[info.filter(isUnique)[j]] = ++nbLect;
                if (isNaN(weekLect[info.filter(isUnique)[j-1]])) {
                    lect = weekLect[info.filter(isUnique)[j]];
                } else {
                ...
                objLect[info.filter(isUnique)[j]] = lect;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'ECLAIRAGE' && date[i] === info.filter(isUnique)[j]) {
                weekEcl[info.filter(isUnique)[j]] = ++nbEcl;
                if (isNaN(weekEcl[info.filter(isUnique)[j-1]])) {
                    ecl = weekEcl[info.filter(isUnique)[j]];
                } else {
                ...
                objEcl[info.filter(isUnique)[j]] = ecl;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'PUPITRE' && date[i] === info.filter(isUnique)[j]) {
                weekPup[info.filter(isUnique)[j]] = ++nbPup;
                if (isNaN(weekPup[info.filter(isUnique)[j-1]])) {
                    pup = weekPup[info.filter(isUnique)[j]];
                } else {
                ...
                objPup[info.filter(isUnique)[j]] = pup;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'SONO' && date[i] === info.filter(isUnique)[j]) {
                weekSono[info.filter(isUnique)[j]] = ++nbSono;
                if (isNaN(weekSono[info.filter(isUnique)[j-1]])) {
                    sono = weekSono[info.filter(isUnique)[j]];
                } else {
                ...
                objSono[info.filter(isUnique)[j]] = sono;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'COUPLEUR' && date[i] === info.filter(isUnique)[j]) {
                weekCoup[info.filter(isUnique)[j]] = ++nbCoup;
                if (isNaN(weekCoup[info.filter(isUnique)[j-1]])) {
                    coup = weekCoup[info.filter(isUnique)[j]];
                } else {
                ...
                objCoup[info.filter(isUnique)[j]] = coup;
            } else if (systeme[i].split('_')[1] === 'H3' && systeme[i].split('_')[2] === 'STMAutonome' && date[i] === info.filter(isUnique)[j]) {
                weekStm[info.filter(isUnique)[j]] = ++nbStm;
                if (isNaN(weekStm[info.filter(isUnique)[j-1]])) {
                    stm = weekStm[info.filter(isUnique)[j]];
                } else {
...
function weekH4(systeme, date, info) {
    ...
    for (let j = 0; j != info.filter(isUnique).length; j++) {
        for (let i = 0; i != systeme.length && i != date.length; i++) {
            if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'BS' && date[i] === info.filter(isUnique)[j]) {
                weekBS[info.filter(isUnique)[j]] = ++nbBS;
                if (isNaN(weekBS[info.filter(isUnique)[j-1]])) {
                    bs = weekBS[info.filter(isUnique)[j]];
                } else {
                ...
                objBS[info.filter(isUnique)[j]] = bs;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'CLIMATISATION' && date[i] === info.filter(isUnique)[j]) {
                weekClim[info.filter(isUnique)[j]] = ++nbClim;
                if (isNaN(weekClim[info.filter(isUnique)[j-1]])) {
                    clim = weekClim[info.filter(isUnique)[j]];
                } else {
                ...
                objClim[info.filter(isUnique)[j]] = clim;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'COMPRESSEUR' && date[i] === info.filter(isUnique)[j]) {
                weekComp[info.filter(isUnique)[j]] = ++nbComp;
                if (isNaN(weekComp[info.filter(isUnique)[j-1]])) {
                    comp = weekComp[info.filter(isUnique)[j]];
                } else {
                ...
                objComp[info.filter(isUnique)[j]] = comp;
            } else if (systeme[i].split('_')[1] === 'H4' && (systeme[i].split('_')[2] === 'Detection' && systeme[i].split('_')[3] ==='incendie') && date[i] === info.filter(isUnique)[j]) {
                weekDetec[info.filter(isUnique)[j]] = ++nbDetec;
                if (isNaN(weekDetec[info.filter(isUnique)[j-1]])) {
                    detec = weekDetec[info.filter(isUnique)[j]];
                } else {
                ...
                objDetec[info.filter(isUnique)[j]] = detec;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'CCTV' && date[i] === info.filter(isUnique)[j]) {
                weekCctv[info.filter(isUnique)[j]] = ++nbCctv;
                if (isNaN(weekCctv[info.filter(isUnique)[j-1]])) {
                    cctv = weekCctv[info.filter(isUnique)[j]];
                } else {
                ...
                objCctv[info.filter(isUnique)[j]] = cctv;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'TCMS' && date[i] === info.filter(isUnique)[j]) {
                weekTcms[info.filter(isUnique)[j]] = ++nbTcms;
                if (isNaN(weekTcms[info.filter(isUnique)[j-1]])) {
                    tcms = weekTcms[info.filter(isUnique)[j]];
                } else {
                ...
                objTcms[info.filter(isUnique)[j]] = tcms;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'TRACTION' && date[i] === info.filter(isUnique)[j]) {
                weekTrac[info.filter(isUnique)[j]] = ++nbTrac;
                if (isNaN(weekTrac[info.filter(isUnique)[j-1]])) {
                    trac = weekTrac[info.filter(isUnique)[j]];
                } else {
                ...
                objTrac[info.filter(isUnique)[j]] = trac;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'ATESS' && date[i] === info.filter(isUnique)[j]) {
                weekAtess[info.filter(isUnique)[j]] == ++nbAtess;
                if (isNaN(weekAtess[info.filter(isUnique)[j-1]])) {
                    atess = weekAtess[info.filter(isUnique)[j]];
                } else {
                ...
                objAtess[info.filter(isUnique)[j]] = atess;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'TDB' && date[i] === info.filter(isUnique)[j]) {
                weekTdb[info.filter(isUnique)[j]] = ++nbTdb;
                if (isNaN(weekTdb[info.filter(isUnique)[j-1]])) {
                    tdb = weekTdb[info.filter(isUnique)[j]];
                } else {
                ...
                objTdb[info.filter(isUnique)[j]] = tdb;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'EMCO' && date[i] === info.filter(isUnique)[j]) {
                weekEmco[info.filter(isUnique)[j]] = ++nbEmco;
                if (isNaN(weekEmco[info.filter(isUnique)[j-1]])) {
                    emco = weekEmco[info.filter(isUnique)[j]];
                } else {
                ...
                objEmco[info.filter(isUnique)[j]] = emco;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'EQS' && date[i] === info.filter(isUnique)[j]) {
                weekEqs[info.filter(isUnique)[j]] = ++nbEqs;
                if (isNaN(weekEqs[info.filter(isUnique)[j-1]])) {
                    eqs = weekEqs[info.filter(isUnique)[j]];
                } else {
                ...
                objEqs[info.filter(isUnique)[j]] = eqs;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'PORTE' && date[i] === info.filter(isUnique)[j]) {
                weekPorte[info.filter(isUnique)[j]] = ++nbPorte;
                if (isNaN(weekPorte[info.filter(isUnique)[j-1]])) {
                    porte = weekPorte[info.filter(isUnique)[j]];
                } else {
                ...
                objPorte[info.filter(isUnique)[j]] = porte;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'FREIN' && date[i] === info.filter(isUnique)[j]) {
                weekFrein[info.filter(isUnique)[j]] = ++nbFrein;
                if (isNaN(weekFrein[info.filter(isUnique)[j-1]])) {
                    frein = weekFrein[info.filter(isUnique)[j]];
                } else {
                ...
                objFrein[info.filter(isUnique)[j]] = frein;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'ComptagePassagers' && date[i] === info.filter(isUnique)[j]) {
                weekCompPass[info.filter(isUnique)[j]] = ++nbCompPass;
                if (isNaN(weekCompPass[info.filter(isUnique)[j-1]])) {
                    compPass = weekCompPass[info.filter(isUnique)[j]];
                } else {
                ...
                objCompPass[info.filter(isUnique)[j]] = compPass;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'AFFICHEUR' && date[i] === info.filter(isUnique)[j]) {
                weekAff[info.filter(isUnique)[j]] = ++nbAff;
                if (isNaN(weekAff[info.filter(isUnique)[j-1]])) {
                    aff = weekAff[info.filter(isUnique)[j]];
                } else {
                ...
                objAff[info.filter(isUnique)[j]] = aff;
            } else if (systeme[i].split('_')[1] === 'H4' && (systeme[i].split('_')[2] === 'LECTEUR' && systeme[i].split('_')[3] === 'BADGE') && date[i] === info.filter(isUnique)[j]) {
                weekLect[info.filter(isUnique)[j]] = ++nbLect;
                if (isNaN(weekLect[info.filter(isUnique)[j-1]])) {
                    lect = weekLect[info.filter(isUnique)[j]];
                } else {
                ...
                objLect[info.filter(isUnique)[j]] = lect;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'ECLAIRAGE' && date[i] === info.filter(isUnique)[j]) {
                weekEcl[info.filter(isUnique)[j]] = ++nbEcl;
                if (isNaN(weekEcl[info.filter(isUnique)[j-1]])) {
                    ecl = weekEcl[info.filter(isUnique)[j]];
                } else {
                ...
                objEcl[info.filter(isUnique)[j]] = ecl;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'PUPITRE' && date[i] === info.filter(isUnique)[j]) {
                weekPup[info.filter(isUnique)[j]] = ++nbPup;
                if (isNaN(weekPup[info.filter(isUnique)[j-1]])) {
                    pup = weekPup[info.filter(isUnique)[j]];
                } else {
                ...
                objPup[info.filter(isUnique)[j]] = pup;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'SONO' && date[i] === info.filter(isUnique)[j]) {
                weekSono[info.filter(isUnique)[j]] = ++nbSono;
                if (isNaN(weekSono[info.filter(isUnique)[j-1]])) {
                    sono = weekSono[info.filter(isUnique)[j]];
                } else {
                ...
                objSono[info.filter(isUnique)[j]] = sono;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'COUPLEUR' && date[i] === info.filter(isUnique)[j]) {
                weekCoup[info.filter(isUnique)[j]] = ++nbCoup;
                if (isNaN(weekCoup[info.filter(isUnique)[j-1]])) {
                    coup = weekCoup[info.filter(isUnique)[j]];
                } else {
                ...
                objCoup[info.filter(isUnique)[j]] = coup;
            } else if (systeme[i].split('_')[1] === 'H4' && systeme[i].split('_')[2] === 'STMAutonome' && date[i] === info.filter(isUnique)[j]) {
                weekStm[info.filter(isUnique)[j]] = ++nbStm;
                if (isNaN(weekStm[info.filter(isUnique)[j-1]])) {
                    stm = weekStm[info.filter(isUnique)[j]];
                } else {
...
function weekH2ByLigneL(rames, systeme, date, info) {
    ...
    for (let x = 0; x != info.filter(isUnique).length; x++) {
        for (let y = 0; y != rames.length; y++) {
            for (let z = 0; z != ligne.length; z++) {
                if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'BS' && date[y] === info.filter(isUnique)[x]) {
                    weekBS[info.filter(isUnique)[x]] = ++nbBS;
                    if (isNaN(weekBS[info.filter(isUnique)[x-1]])) {
                        bs = weekBS[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objBS[info.filter(isUnique)[x]] = bs;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'CLIMATISATION' && date[y] === info.filter(isUnique)[x]) {
                    weekClim[info.filter(isUnique)[x]] = ++nbClim;
                    if (isNaN(weekClim[info.filter(isUnique)[x-1]])) {
                        clim = weekClim[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objClim[info.filter(isUnique)[x]] = clim;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'COMPRESSEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekComp[info.filter(isUnique)[x]] = ++nbComp;
                    if (isNaN(weekComp[info.filter(isUnique)[x-1]])) {
                        comp = weekComp[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objComp[info.filter(isUnique)[x]] = comp;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && (systeme[y].split('_')[2] === 'Detection' && systeme[i].split('_')[3] ==='incendie') && date[y] === info.filter(isUnique)[x]) {
                    weekDetec[info.filter(isUnique)[x]] = ++nbDetec;
                    if (isNaN(weekDetec[info.filter(isUnique)[x-1]])) {
                        detec = weekDetec[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objDetec[info.filter(isUnique)[x]] = detec;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'CCTV' && date[y] === info.filter(isUnique)[x]) {
                    weekCctv[info.filter(isUnique)[x]] = ++nbCctv;
                    if (isNaN(weekCctv[info.filter(isUnique)[x-1]])) {
                        cctv = weekCctv[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCctv[info.filter(isUnique)[x]] = cctv;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'TCMS' && date[y] === info.filter(isUnique)[x]) {
                    weekTcms[info.filter(isUnique)[x]] = ++nbTcms;
                    if (isNaN(weekTcms[info.filter(isUnique)[x-1]])) {
                        tcms = weekTcms[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTcms[info.filter(isUnique)[x]] = tcms;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'TRACTION' && date[y] === info.filter(isUnique)[x]) {
                    weekTrac[info.filter(isUnique)[x]] = ++nbTrac;
                    if (isNaN(weekTrac[info.filter(isUnique)[x-1]])) {
                        trac = weekTrac[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTrac[info.filter(isUnique)[x]] = trac;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'ATESS' && date[y] === info.filter(isUnique)[x]) {
                    weekAtess[info.filter(isUnique)[x]] == ++nbAtess;
                    if (isNaN(weekAtess[info.filter(isUnique)[x-1]])) {
                        atess = weekAtess[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objAtess[info.filter(isUnique)[x]] = atess;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'TDB' && date[y] === info.filter(isUnique)[x]) {
                    weekTdb[info.filter(isUnique)[x]] = ++nbTdb;
                    if (isNaN(weekTdb[info.filter(isUnique)[x-1]])) {
                        tdb = weekTdb[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTdb[info.filter(isUnique)[x]] = tdb;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'EMCO' && date[y] === info.filter(isUnique)[x]) {
                    weekEmco[info.filter(isUnique)[x]] = ++nbEmco;
                    if (isNaN(weekEmco[info.filter(isUnique)[x-1]])) {
                        emco = weekEmco[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objEmco[info.filter(isUnique)[x]] = emco;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'EQS' && date[y] === info.filter(isUnique)[x]) {
                    weekEqs[info.filter(isUnique)[x]] = ++nbEqs;
                    if (isNaN(weekEqs[info.filter(isUnique)[x-1]])) {
                        eqs = weekEqs[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objEqs[info.filter(isUnique)[x]] = eqs;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'PORTE' && date[y] === info.filter(isUnique)[x]) {
                    weekPorte[info.filter(isUnique)[x]] = ++nbPorte;
                    if (isNaN(weekPorte[info.filter(isUnique)[x-1]])) {
                        porte = weekPorte[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objPorte[info.filter(isUnique)[x]] = porte;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'FREIN' && date[y] === info.filter(isUnique)[x]) {
                    weekFrein[info.filter(isUnique)[x]] = ++nbFrein;
                    if (isNaN(weekFrein[info.filter(isUnique)[x-1]])) {
                        frein = weekFrein[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objFrein[info.filter(isUnique)[x]] = frein;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'ComptagePassagers' && date[y] === info.filter(isUnique)[x]) {
                    weekCompPass[info.filter(isUnique)[x]] = ++nbCompPass;
                    if (isNaN(weekCompPass[info.filter(isUnique)[x-1]])) {
                        compPass = weekCompPass[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCompPass[info.filter(isUnique)[x]] = compPass;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'AFFICHEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekAff[info.filter(isUnique)[x]] = ++nbAff;
                    if (isNaN(weekAff[info.filter(isUnique)[x-1]])) {
                        aff = weekAff[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objAff[info.filter(isUnique)[x]] = aff;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && (systeme[y].split('_')[2] === 'LECTEUR' && systeme[i].split('_')[3] === 'BADGE') && date[y] === info.filter(isUnique)[x]) {
                    weekLect[info.filter(isUnique)[x]] = ++nbLect;
                    if (isNaN(weekLect[info.filter(isUnique)[x-1]])) {
                        lect = weekLect[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objLect[info.filter(isUnique)[x]] = lect;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'ECLAIRAGE' && date[y] === info.filter(isUnique)[x]) {
                    weekEcl[info.filter(isUnique)[x]] = ++nbEcl;
                if (isNaN(weekEcl[info.filter(isUnique)[x-1]])) {
                    ecl = weekEcl[info.filter(isUnique)[x]];
                } else {
                ...
                objEcl[info.filter(isUnique)[x]] = ecl;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'PUPITRE' && date[y] === info.filter(isUnique)[x]) {
                    weekPup[info.filter(isUnique)[x]] = ++nbPup;
                    if (isNaN(weekPup[info.filter(isUnique)[x-1]])) {
                        pup = weekPup[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objPup[info.filter(isUnique)[x]] = pup;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'SONO' && date[y] === info.filter(isUnique)[x]) {
                    weekSono[info.filter(isUnique)[x]] = ++nbSono;
                    if (isNaN(weekSono[info.filter(isUnique)[x-1]])) {
                        sono = weekSono[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objSono[info.filter(isUnique)[x]] = sono;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'COUPLEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekCoup[info.filter(isUnique)[x]] = ++nbCoup;
                    if (isNaN(weekCoup[info.filter(isUnique)[x-1]])) {
                        coup = weekCoup[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCoup[info.filter(isUnique)[x]] = coup;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H2' && systeme[y].split('_')[2] === 'STMAutonome' && date[y] === info.filter(isUnique)[x]) {
                    weekStm[info.filter(isUnique)[x]] = ++nbStm;
                    if (isNaN(weekStm[info.filter(isUnique)[x-1]])) {
                        stm = weekStm[info.filter(isUnique)[x]];
                    } else {
...
function weekH3ByLigneL(rames, systeme, date, info) {
    ...
    for (let x = 0; x != info.filter(isUnique).length; x++) {
        for (let y = 0; y != rames.length; y++) {
            for (let z = 0; z != ligne.length; z++) {
                if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'BS' && date[y] === info.filter(isUnique)[x]) {
                    weekBS[info.filter(isUnique)[x]] = ++nbBS;
                    if (isNaN(weekBS[info.filter(isUnique)[x-1]])) {
                        bs = weekBS[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objBS[info.filter(isUnique)[x]] = bs;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'CLIMATISATION' && date[y] === info.filter(isUnique)[x]) {
                    weekClim[info.filter(isUnique)[x]] = ++nbClim;
                    if (isNaN(weekClim[info.filter(isUnique)[x-1]])) {
                        clim = weekClim[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objClim[info.filter(isUnique)[x]] = clim;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'COMPRESSEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekComp[info.filter(isUnique)[x]] = ++nbComp;
                    if (isNaN(weekComp[info.filter(isUnique)[x-1]])) {
                        comp = weekComp[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objComp[info.filter(isUnique)[x]] = comp;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && (systeme[y].split('_')[2] === 'Detection' && systeme[i].split('_')[3] ==='incendie') && date[y] === info.filter(isUnique)[x]) {
                    weekDetec[info.filter(isUnique)[x]] = ++nbDetec;
                    if (isNaN(weekDetec[info.filter(isUnique)[x-1]])) {
                        detec = weekDetec[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objDetec[info.filter(isUnique)[x]] = detec;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'CCTV' && date[y] === info.filter(isUnique)[x]) {
                    weekCctv[info.filter(isUnique)[x]] = ++nbCctv;
                    if (isNaN(weekCctv[info.filter(isUnique)[x-1]])) {
                        cctv = weekCctv[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCctv[info.filter(isUnique)[x]] = cctv;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'TCMS' && date[y] === info.filter(isUnique)[x]) {
                    weekTcms[info.filter(isUnique)[x]] = ++nbTcms;
                    if (isNaN(weekTcms[info.filter(isUnique)[x-1]])) {
                        tcms = weekTcms[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTcms[info.filter(isUnique)[x]] = tcms;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'TRACTION' && date[y] === info.filter(isUnique)[x]) {
                    weekTrac[info.filter(isUnique)[x]] = ++nbTrac;
                    if (isNaN(weekTrac[info.filter(isUnique)[x-1]])) {
                        trac = weekTrac[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTrac[info.filter(isUnique)[x]] = trac;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'ATESS' && date[y] === info.filter(isUnique)[x]) {
                    weekAtess[info.filter(isUnique)[x]] == ++nbAtess;
                    if (isNaN(weekAtess[info.filter(isUnique)[x-1]])) {
                        atess = weekAtess[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objAtess[info.filter(isUnique)[x]] = atess;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'TDB' && date[y] === info.filter(isUnique)[x]) {
                    weekTdb[info.filter(isUnique)[x]] = ++nbTdb;
                    if (isNaN(weekTdb[info.filter(isUnique)[x-1]])) {
                        tdb = weekTdb[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTdb[info.filter(isUnique)[x]] = tdb;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'EMCO' && date[y] === info.filter(isUnique)[x]) {
                    weekEmco[info.filter(isUnique)[x]] = ++nbEmco;
                    if (isNaN(weekEmco[info.filter(isUnique)[x-1]])) {
                        emco = weekEmco[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objEmco[info.filter(isUnique)[x]] = emco;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'EQS' && date[y] === info.filter(isUnique)[x]) {
                    weekEqs[info.filter(isUnique)[x]] = ++nbEqs;
                    if (isNaN(weekEqs[info.filter(isUnique)[x-1]])) {
                        eqs = weekEqs[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objEqs[info.filter(isUnique)[x]] = eqs;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'PORTE' && date[y] === info.filter(isUnique)[x]) {
                    weekPorte[info.filter(isUnique)[x]] = ++nbPorte;
                    if (isNaN(weekPorte[info.filter(isUnique)[x-1]])) {
                        porte = weekPorte[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objPorte[info.filter(isUnique)[x]] = porte;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'FREIN' && date[y] === info.filter(isUnique)[x]) {
                    weekFrein[info.filter(isUnique)[x]] = ++nbFrein;
                    if (isNaN(weekFrein[info.filter(isUnique)[x-1]])) {
                        frein = weekFrein[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objFrein[info.filter(isUnique)[x]] = frein;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'ComptagePassagers' && date[y] === info.filter(isUnique)[x]) {
                    weekCompPass[info.filter(isUnique)[x]] = ++nbCompPass;
                    if (isNaN(weekCompPass[info.filter(isUnique)[x-1]])) {
                        compPass = weekCompPass[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCompPass[info.filter(isUnique)[x]] = compPass;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'AFFICHEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekAff[info.filter(isUnique)[x]] = ++nbAff;
                    if (isNaN(weekAff[info.filter(isUnique)[x-1]])) {
                        aff = weekAff[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objAff[info.filter(isUnique)[x]] = aff;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && (systeme[y].split('_')[2] === 'LECTEUR' && systeme[i].split('_')[3] === 'BADGE') && date[y] === info.filter(isUnique)[x]) {
                    weekLect[info.filter(isUnique)[x]] = ++nbLect;
                    if (isNaN(weekLect[info.filter(isUnique)[x-1]])) {
                        lect = weekLect[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objLect[info.filter(isUnique)[x]] = lect;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'ECLAIRAGE' && date[y] === info.filter(isUnique)[x]) {
                    weekEcl[info.filter(isUnique)[x]] = ++nbEcl;
                if (isNaN(weekEcl[info.filter(isUnique)[x-1]])) {
                    ecl = weekEcl[info.filter(isUnique)[x]];
                } else {
                ...
                objEcl[info.filter(isUnique)[x]] = ecl;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'PUPITRE' && date[y] === info.filter(isUnique)[x]) {
                    weekPup[info.filter(isUnique)[x]] = ++nbPup;
                    if (isNaN(weekPup[info.filter(isUnique)[x-1]])) {
                        pup = weekPup[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objPup[info.filter(isUnique)[x]] = pup;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'SONO' && date[y] === info.filter(isUnique)[x]) {
                    weekSono[info.filter(isUnique)[x]] = ++nbSono;
                    if (isNaN(weekSono[info.filter(isUnique)[x-1]])) {
                        sono = weekSono[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objSono[info.filter(isUnique)[x]] = sono;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'COUPLEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekCoup[info.filter(isUnique)[x]] = ++nbCoup;
                    if (isNaN(weekCoup[info.filter(isUnique)[x-1]])) {
                        coup = weekCoup[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCoup[info.filter(isUnique)[x]] = coup;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H3' && systeme[y].split('_')[2] === 'STMAutonome' && date[y] === info.filter(isUnique)[x]) {
                    weekStm[info.filter(isUnique)[x]] = ++nbStm;
                    if (isNaN(weekStm[info.filter(isUnique)[x-1]])) {
                        stm = weekStm[info.filter(isUnique)[x]];
                    } else {
...
function weekH4ByLigneL(rames, systeme, date, info) {
    ...
    for (let x = 0; x != info.filter(isUnique).length; x++) {
        for (let y = 0; y != rames.length; y++) {
            for (let z = 0; z != ligne.length; z++) {
                if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'BS' && date[y] === info.filter(isUnique)[x]) {
                    weekBS[info.filter(isUnique)[x]] = ++nbBS;
                    if (isNaN(weekBS[info.filter(isUnique)[x-1]])) {
                        bs = weekBS[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objBS[info.filter(isUnique)[x]] = bs;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'CLIMATISATION' && date[y] === info.filter(isUnique)[x]) {
                    weekClim[info.filter(isUnique)[x]] = ++nbClim;
                    if (isNaN(weekClim[info.filter(isUnique)[x-1]])) {
                        clim = weekClim[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objClim[info.filter(isUnique)[x]] = clim;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'COMPRESSEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekComp[info.filter(isUnique)[x]] = ++nbComp;
                    if (isNaN(weekComp[info.filter(isUnique)[x-1]])) {
                        comp = weekComp[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objComp[info.filter(isUnique)[x]] = comp;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && (systeme[y].split('_')[2] === 'Detection' && systeme[i].split('_')[3] ==='incendie') && date[y] === info.filter(isUnique)[x]) {
                    weekDetec[info.filter(isUnique)[x]] = ++nbDetec;
                    if (isNaN(weekDetec[info.filter(isUnique)[x-1]])) {
                        detec = weekDetec[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objDetec[info.filter(isUnique)[x]] = detec;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'CCTV' && date[y] === info.filter(isUnique)[x]) {
                    weekCctv[info.filter(isUnique)[x]] = ++nbCctv;
                    if (isNaN(weekCctv[info.filter(isUnique)[x-1]])) {
                        cctv = weekCctv[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCctv[info.filter(isUnique)[x]] = cctv;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'TCMS' && date[y] === info.filter(isUnique)[x]) {
                    weekTcms[info.filter(isUnique)[x]] = ++nbTcms;
                    if (isNaN(weekTcms[info.filter(isUnique)[x-1]])) {
                        tcms = weekTcms[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTcms[info.filter(isUnique)[x]] = tcms;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'TRACTION' && date[y] === info.filter(isUnique)[x]) {
                    weekTrac[info.filter(isUnique)[x]] = ++nbTrac;
                    if (isNaN(weekTrac[info.filter(isUnique)[x-1]])) {
                        trac = weekTrac[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTrac[info.filter(isUnique)[x]] = trac;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'ATESS' && date[y] === info.filter(isUnique)[x]) {
                    weekAtess[info.filter(isUnique)[x]] == ++nbAtess;
                    if (isNaN(weekAtess[info.filter(isUnique)[x-1]])) {
                        atess = weekAtess[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objAtess[info.filter(isUnique)[x]] = atess;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'TDB' && date[y] === info.filter(isUnique)[x]) {
                    weekTdb[info.filter(isUnique)[x]] = ++nbTdb;
                    if (isNaN(weekTdb[info.filter(isUnique)[x-1]])) {
                        tdb = weekTdb[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objTdb[info.filter(isUnique)[x]] = tdb;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'EMCO' && date[y] === info.filter(isUnique)[x]) {
                    weekEmco[info.filter(isUnique)[x]] = ++nbEmco;
                    if (isNaN(weekEmco[info.filter(isUnique)[x-1]])) {
                        emco = weekEmco[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objEmco[info.filter(isUnique)[x]] = emco;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'EQS' && date[y] === info.filter(isUnique)[x]) {
                    weekEqs[info.filter(isUnique)[x]] = ++nbEqs;
                    if (isNaN(weekEqs[info.filter(isUnique)[x-1]])) {
                        eqs = weekEqs[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objEqs[info.filter(isUnique)[x]] = eqs;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'PORTE' && date[y] === info.filter(isUnique)[x]) {
                    weekPorte[info.filter(isUnique)[x]] = ++nbPorte;
                    if (isNaN(weekPorte[info.filter(isUnique)[x-1]])) {
                        porte = weekPorte[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objPorte[info.filter(isUnique)[x]] = porte;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'FREIN' && date[y] === info.filter(isUnique)[x]) {
                    weekFrein[info.filter(isUnique)[x]] = ++nbFrein;
                    if (isNaN(weekFrein[info.filter(isUnique)[x-1]])) {
                        frein = weekFrein[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objFrein[info.filter(isUnique)[x]] = frein;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'ComptagePassagers' && date[y] === info.filter(isUnique)[x]) {
                    weekCompPass[info.filter(isUnique)[x]] = ++nbCompPass;
                    if (isNaN(weekCompPass[info.filter(isUnique)[x-1]])) {
                        compPass = weekCompPass[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCompPass[info.filter(isUnique)[x]] = compPass;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'AFFICHEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekAff[info.filter(isUnique)[x]] = ++nbAff;
                    if (isNaN(weekAff[info.filter(isUnique)[x-1]])) {
                        aff = weekAff[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objAff[info.filter(isUnique)[x]] = aff;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && (systeme[y].split('_')[2] === 'LECTEUR' && systeme[i].split('_')[3] === 'BADGE') && date[y] === info.filter(isUnique)[x]) {
                    weekLect[info.filter(isUnique)[x]] = ++nbLect;
                    if (isNaN(weekLect[info.filter(isUnique)[x-1]])) {
                        lect = weekLect[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objLect[info.filter(isUnique)[x]] = lect;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'ECLAIRAGE' && date[y] === info.filter(isUnique)[x]) {
                    weekEcl[info.filter(isUnique)[x]] = ++nbEcl;
                if (isNaN(weekEcl[info.filter(isUnique)[x-1]])) {
                    ecl = weekEcl[info.filter(isUnique)[x]];
                } else {
                ...
                objEcl[info.filter(isUnique)[x]] = ecl;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'PUPITRE' && date[y] === info.filter(isUnique)[x]) {
                    weekPup[info.filter(isUnique)[x]] = ++nbPup;
                    if (isNaN(weekPup[info.filter(isUnique)[x-1]])) {
                        pup = weekPup[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objPup[info.filter(isUnique)[x]] = pup;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'SONO' && date[y] === info.filter(isUnique)[x]) {
                    weekSono[info.filter(isUnique)[x]] = ++nbSono;
                    if (isNaN(weekSono[info.filter(isUnique)[x-1]])) {
                        sono = weekSono[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objSono[info.filter(isUnique)[x]] = sono;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'COUPLEUR' && date[y] === info.filter(isUnique)[x]) {
                    weekCoup[info.filter(isUnique)[x]] = ++nbCoup;
                    if (isNaN(weekCoup[info.filter(isUnique)[x-1]])) {
                        coup = weekCoup[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objCoup[info.filter(isUnique)[x]] = coup;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'STMAutonome' && date[y] === info.filter(isUnique)[x]) {
                    weekStm[info.filter(isUnique)[x]] = ++nbStm;
                    if (isNaN(weekStm[info.filter(isUnique)[x-1]])) {
                        stm = weekStm[info.filter(isUnique)[x]];
                    } else {
        ...
        for (let y = 0; y != rames.length; y++) {
            for (let z = 0; z != ligne.length; z++) {
                if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && systeme[y].split('_')[2] === 'BS' && date[y] === info.filter(isUnique)[x]) {
                    ...
                    objComp[info.filter(isUnique)[x]] = comp;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && (systeme[y].split('_')[2] === 'Detection' && systeme[y].split('_')[3] ==='incendie') && date[y] === info.filter(isUnique)[x]) {
                    weekDetec[info.filter(isUnique)[x]] = ++nbDetec;
                    if (isNaN(weekDetec[info.filter(isUnique)[x-1]])) {
                        detec = weekDetec[info.filter(isUnique)[x]];
                    } else {
                    ...
                    objAff[info.filter(isUnique)[x]] = aff;
                } else if (ligne[z] === rames[y] && systeme[y].split('_')[1] === 'H4' && (systeme[y].split('_')[2] === 'LECTEUR' && systeme[y].split('_')[3] === 'BADGE') && date[y] === info.filter(isUnique)[x]) {
                    weekLect[info.filter(isUnique)[x]] = ++nbLect;
                    if (isNaN(weekLect[info.filter(isUnique)[x-1]])) {
                        lect = weekLect[info.filter(isUnique)[x]];
                    } else {
